...
namespace RestaurantClient_Cook.EventPublisher {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="EventPublisher.IEventPublisher", CallbackContract=typeof(RestaurantClient_Cook.EventPublisher.IEventPublisherCallback))]
    ...
    public interface IEventPublisherCallback {
        ...
        void OnPublishedEvent(RestaurantClient_Cook.EventPublisher.Event e);
        ...
        void OrderCompletionTimePushed(RestaurantClient_Cook.EventPublisher.OrderUpdate update);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IEventPublisher/NewOrder")]
        void NewOrder(RestaurantClient_Cook.EventPublisher.Order update, RestaurantClient_Cook.EventPublisher.Customer customer);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IEventPublisherChannel : RestaurantClient_Cook.EventPublisher.IEventPublisher, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class EventPublisherClient : System.ServiceModel.DuplexClientBase<RestaurantClient_Cook.EventPublisher.IEventPublisher>, RestaurantClient_Cook.EventPublisher.IEventPublisher {
